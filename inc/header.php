...
<head>
	...
	<link rel="icon" href="https://cdn.imgbin.com/25/20/14/imgbin-microsoft-store-windows-10-xbox-one-window-zGpqx6aLVbeb950FUjAxzVYUg.jpg">
...
<div class="menu">
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  <!-- neu user login thi cho xem Profile -->
	  <?php
	  	$login_check = Session::get('customer_login');
	  	if($login_check == false){
	  		echo '';
